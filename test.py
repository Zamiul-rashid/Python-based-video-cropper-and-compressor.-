...
class VideoTrimmer:
    ...
    def load_video(self, index):
        if 0 <= index < len(self.video_files):
            ...
            if self.fps == 0:
                self.fps = 30  # Default FPS if retrieval fails
    ...
    def process_video(self):
        ...
        while True:
            ...
            time_to_wait = max(1.0 / self.fps - elapsed_time, 0)
